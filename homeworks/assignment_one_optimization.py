...
def main():
    ...
    squared_loss = lambda beta: 0
    squared_loss_grad = lambda beta: beta
    squared_loss_grad_1d = lambda beta, j: 0
    ...
    # along with the 3 functions: loss_calculator, loss_grad_calculator,
    # and loss_grad_1d_calculator
    logistic_loss = lambda beta: 0
    logistic_loss_grad = lambda beta: beta
    logistic_loss_grad_1d = lambda beta, j: 0
